...
document.getElementById('colorButton').addEventListener('click', function() {
    ...
    var changeable = document.getElementById('greeting');
    changeable.style.color = getRandomColor();
});
...
document.getElementById('textButton').addEventListener('click', function() {
    ...
    changeable = document.getElementById('greeting');
    changeable.textContent = "Hello, JavaScript!";
